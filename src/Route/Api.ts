...
import { DeleteFeed, SaveFeed, UpdateFeed, MainList, FixGreat, PersonalList, NicknamePersonalList } from '@Controllers/Api/FeedController'
...
FeedRouter.get(`/my-feed-list`, RestAuthenticateMiddleware, PersonalList)
